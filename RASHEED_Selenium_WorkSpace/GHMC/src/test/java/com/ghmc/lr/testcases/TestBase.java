...
import com.ghmc.lr.util.ExtentManager;
import com.ghmc.lr.util.WaitUtil;
import com.ghmc.lr.util.Xls_Reader;
...
public class TestBase {
	...
	public String actualAlertText=null;
...
{
	//APP_LOGS.info(enterText+"  entered in the text box "+element.getText());
	try {
		WaitUtil.waitForElementVisible(element);
		element.clear();
		element.sendKeys(enterText);
		//test.log(LogStatus.INFO,"entered  "+enterText+ " in the text field "+element.getAttribute("id"));
...
public static void select_Option_In_DropDown_ByVisibleText(WebElement element, String VisibleTextOptionToSelect) {
	...
	try {
		...
		test.log(LogStatus.INFO, "selecting "+VisibleTextOptionToSelect+") From Select List :"+element.getAttribute("id"));
	} catch (StaleElementReferenceException e) {
		System.out.println("Element is not attached to the page document "
				+ e.getStackTrace());
