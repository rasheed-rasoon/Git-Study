...
import com.cgg.Pages.GrievanceHomePageConstants;
...
@Test(dataProvider="getData")
	...
	public void testLogin(Hashtable <String,String>data) throws Exception{
		...
		GrievanceHomePage home=PageFactory.initElements(driver,GrievanceHomePageConstants.class);
		...
		if(data.get("DataFlag").equalsIgnoreCase("P")){
			Assert.assertTrue(home.iscitizenAppSubmittedSuccessfully(data.get("alertText")),"citizen submitted succesfully");
			reportpass("citizen submitted successfully");
		}	else{
				reportFail("citizen not submitted successfully");
			}
