...
public class AssertionsUtil extends TestBase {
	...
	public static boolean verifyalertmessageForCItiZenGrievance(String data){
		APP_LOGS.info("Verifying the Alert Message CItiZen Grievance");
		Alert alert = driver.switchTo().alert();//Switch to Pop window from main window

		String Actual=alert.getText().substring(0,35);
		String Expected=data;
