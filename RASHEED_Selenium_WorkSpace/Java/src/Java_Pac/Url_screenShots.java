...
public class Url_screenShots {
  ...
  public void f() throws BiffException, IOException {
	  ...
	  FileInputStream fis = new FileInputStream("F:\\RASHEED_Selenium_WorkSpace\\Java\\URL's.xls");  //creating reference variable for File input stream
		Workbook wb = Workbook.getWorkbook(fis);
		Sheet s = wb.getSheet(0);
		//String str1 = "";
		for (int i =91; i<=s.getRows(); i++) 
		{
